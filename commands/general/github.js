...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/OAD-26/JOGOBot-Mini';
            const apiUrl = 'https://api.github.com/repos/OAD-26/JOGOBot-Mini';
            ...
            try {
                ...
                fallbackMessage += `🔗 *Repository:* JOGOBot-Mini\n`;
                fallbackMessage += `👨‍💻 *Owner:* OAD-26\n`;
